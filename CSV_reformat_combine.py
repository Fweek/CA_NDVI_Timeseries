...
#Set working directory to Output directory of reformated files
os.chdir(str(sys.argv[1])+'/Output')
...
filecount = len([f for f in os.listdir(str(sys.argv[1])+'/Output') if os.path.isfile(f)])
